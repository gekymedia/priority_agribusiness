        ...
        <form method="POST" action="<?php echo e(route('expenses.update', $expense)); ?>">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="farm_id" id="farm_id" class="form-select <?php $__errorArgs = ['farm_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php $__currentLoopData = $farms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $farm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($farm->id); ?>" <?php echo e(old('farm_id', $expense->farm_id) == $farm->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($batch->id); ?>" <?php echo e(old('bird_batch_id', $expense->bird_batch_id) == $batch->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date', $expense->date->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="amount" id="amount" step="0.01" class="form-control <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('amount', $expense->amount)); ?>" min="0" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\priority_agribusiness\resources\views/expenses/edit.blade.php ENDPATH**/ ?>