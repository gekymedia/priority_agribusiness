    ...
    <nav class="d-flex justify-items-center justify-content-between">
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                ...
                <?php else: ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev">&laquo; <?php echo app('translator')->get('pagination.previous'); ?></a>
                    </li>
                <?php endif; ?>
                ...
                <?php if($paginator->hasMorePages()): ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next"><?php echo app('translator')->get('pagination.next'); ?> &raquo;</a>
                    </li>
                <?php else: ?>
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link"><?php echo app('translator')->get('pagination.next'); ?> &raquo;</span>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\projects\priority_agribusiness\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>