        ...
        <div class="col-lg-8">
                                    ...
                                    <div class="channel-content">
                                        ...
                                        <div class="channel-status">
                                            ...
                                            <?php if($smsConfigured): ?>
                                                <span class="status-configured"><i class="fas fa-check-circle"></i> <?php echo e($providerName ?: 'Configured'); ?></span>
                                            <?php else: ?>
                                                <span class="status-not-configured"><i class="fas fa-exclamation-circle"></i> Not Configured</span>
                                            <?php endif; ?>
                                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered notification-settings-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-bold">
                                        <i class="fas fa-<?php echo e($moduleKey === 'egg_production' ? 'egg' : ($moduleKey === 'egg_sales' ? 'shopping-cart' : ($moduleKey === 'bird_sales' ? 'dove' : ($moduleKey === 'expenses' ? 'receipt' : 'users')))); ?> me-2 text-muted"></i>
            ...
            <div class="agri-card mb-4">
                ...
                <div class="agri-card-body">
                    ...
                    <form action="<?php echo e(route('settings.priority-bank.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="row g-3">
                            <div class="col-12">
                                <label for="priority_bank_api_url" class="form-label">API URL</label>
                                <input type="url" name="priority_bank_api_url" id="priority_bank_api_url" class="form-control" value="<?php echo e(old('priority_bank_api_url', $priorityBankSettings['priority_bank_api_url'] ?? '')); ?>" placeholder="https://bank.prioritysolutionsagency.com">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="password" name="priority_bank_api_token" id="priority_bank_api_token" class="form-control" value="" placeholder="<?php echo e(!empty($priorityBankSettings['priority_bank_api_token']) ? '•••••••••••• (stored – leave blank to keep)' : 'Enter API token'); ?>" autocomplete="off" data-token-stored="<?php echo e(!empty($priorityBankSettings['priority_bank_api_token']) ? '1' : '0'); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="priority_bank_system_id" id="priority_bank_system_id" class="form-control" value="<?php echo e(old('priority_bank_system_id', $priorityBankSettings['priority_bank_system_id'] ?? 'priority_agriculture')); ?>" placeholder="priority_agriculture">
                ...
                <div class="agri-card-body">
                    <div class="config-status-list">
                        ...
                        <div class="config-item">
                            ...
                            <div class="config-value">
                                <?php if($smsConfigured): ?>
                                    <span class="badge bg-success"><?php echo e($providerName ?: 'Configured'); ?></span>
                                <?php else: ?>
                                    <span class="badge bg-secondary">Log Mode</span>
                                <?php endif; ?>
                            </div>
                ...
                <div class="agri-card-body">
                    <div class="config-status-list">
                        <div class="config-item">
                            ...
                            <div class="config-value">
                                <span class="badge <?php echo e(config('app.env') === 'production' ? 'bg-success' : 'bg-warning'); ?>">
                        ...
                        <div class="config-item">
                            ...
                            <div class="config-value">
                                <span class="badge <?php echo e(config('app.debug') ? 'bg-warning' : 'bg-success'); ?>">
...
<script>
    ...
    function sendTestNotification() {
        ...
        fetch('<?php echo e(route("settings.test-notification")); ?>', {
            method: 'POST',
            headers: {
    ...
    function toggleNotificationSetting(checkbox) {
        ...
        fetch('<?php echo e(route("settings.notification-settings")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\priority_agribusiness\resources\views/settings/index.blade.php ENDPATH**/ ?>