...
<head>
    ...
    <link rel="icon" type="image/png" sizes="48x48" href="{{ asset('favicon/priority_agriculture_48x48.png') }}">
    <link rel="icon" type="image/png" sizes="64x64" href="{{ asset('favicon/priority_agriculture_64x64.png') }}">
    <link rel="apple-touch-icon" sizes="192x192" href="{{ asset('mobile/priority_agriculture_192x192.png') }}">
    <link rel="apple-touch-icon" sizes="512x512" href="{{ asset('mobile/priority_agriculture_512x512.png') }}">
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <div class="sidebar-menu-item">
                <a href="{{ route('plantings.index') }}" class="sidebar-link {{ request()->routeIs('plantings.*') ? 'active' : '' }}">
