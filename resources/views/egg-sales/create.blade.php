        ...
        <form method="POST" action="{{ route('egg-sales.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="price_per_unit" id="price_per_unit" step="0.01" class="form-control @error('price_per_unit') is-invalid @enderror" value="{{ old('price_per_unit') }}" min="0" required>
