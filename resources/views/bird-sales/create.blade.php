...
@section('title', 'Record Bird Sale')

@section('content')
<div class="page-header">
    <h1 class="page-title">Record Bird Sale</h1>
    <p class="page-subtitle">Record a new bird/chicken sale transaction</p>
</div>

<div class="agri-card">
    <div class="agri-card-body">
        <form method="POST" action="{{ route('bird-sales.store') }}">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="quantity_sold" id="quantity_sold" class="form-control @error('quantity_sold') is-invalid @enderror" value="{{ old('quantity_sold') }}" min="1" required>
                    @error('quantity_sold')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="price_per_bird" id="price_per_bird" step="0.01" class="form-control @error('price_per_bird') is-invalid @enderror" value="{{ old('price_per_bird') }}" min="0" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="buyer_name" id="buyer_name" class="form-control @error('buyer_name') is-invalid @enderror" value="{{ old('buyer_name') }}">
                    @error('buyer_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="buyer_contact" id="buyer_contact" class="form-control @error('buyer_contact') is-invalid @enderror" value="{{ old('buyer_contact') }}">
                    @error('buyer_contact')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
