...
<div class="page-header">
    <h1 class="page-title">Add Mortality Record</h1>
    <p class="page-subtitle">Record daily bird mortality, culling, and other metrics</p>
</div>

<div class="agri-card">
    <div class="agri-card-body">
        <form method="POST" action="{{ route('bird-mortality.store') }}">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="mortality_count" class="form-control @error('mortality_count') is-invalid @enderror" 
                           value="{{ old('mortality_count', 0) }}" min="0" required>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.1" name="water_used_litres" class="form-control @error('water_used_litres') is-invalid @enderror" 
                           value="{{ old('water_used_litres') }}" min="0">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" name="average_weight_kg" class="form-control @error('average_weight_kg') is-invalid @enderror" 
                           value="{{ old('average_weight_kg') }}" min="0">
