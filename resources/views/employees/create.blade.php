        ...
        <form method="POST" action="{{ route('employees.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" placeholder="e.g. 0241234567">
                    @error('phone')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="phone_alt" value="{{ old('phone_alt') }}" class="form-control" placeholder="Second SIM for USSD access">
